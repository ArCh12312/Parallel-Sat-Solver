...
class Look_ahead_Solver:
    ...
    def look_ahead_dpll_1(self, formula, model = [], decide_pos = [], depth = 0):
        ...
        if depth == 3:
            self.cubes.append([best_formula, best_model])
            self.cubes.append([alternative_formula, alternative_model])
